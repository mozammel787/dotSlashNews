...
const HomeOuther = ({news}) => {
  return (
	...
	<div className="container mx-auto flex flex-col justify-between p-4 text-center md:p-10 lg:flex-row">
            ...
            <div className="flex ">
            <img className="invert " src="./fev.png" alt="" />
            <div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracking-widest uppercase text-black">Hic eligendi necessitatibus quod quia</p>
			<h1 className="py-2 text-4xl font-medium leading-tight title-font">Download Our Dot Slash News App</h1>
		</div>
            </div>
