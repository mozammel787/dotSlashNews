...
const HomeOuther = ({ news }) => {
  return (
    <div>
      <div className="max-w-screen mx-auto relative my-5 sm:my-10 p-5 sm:p-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <HomeEntertainment news={news} />
          <HomeScience news={news} />
          <HomeTechnology news={news} />
        </div>
      </div>
      <section className="py-6 my-10 bg-gray-100 text-gray-900">
        <div className="container mx-auto flex flex-col justify-between p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col items-center md:flex-row ">
            <img className="invert w-20" src="./fev.png" alt="" />
            <div className="flex flex-col justify-center lg:text-left">
              <p className="mb-1 text-sm font-medium tracking-widest uppercase text-black">
                Hic eligendi necessitatibus quod quia
              </p>
              <h1 className="py-2 text-xl md:text-4xl font-medium leading-tight title-font">
                Download Our Dot Slash News App
              </h1>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            <button className="inline-flex items-center px-6 py-3 rounded bg-black text-gray-50">
              <svg
            ...
            <button className="inline-flex items-center px-5 py-3 rounded bg-black text-gray-50">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                className="fill-current w-7 h-7 text-gray-50"
