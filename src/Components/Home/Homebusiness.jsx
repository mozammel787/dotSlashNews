...
const Homebusiness = ({ news }) => {
  ...
  return (
    <div className="max-w-screen mx-auto relative p-5 sm:p-0 my-20">
        <div className="border-b mb-5 flex justify-between text-sm">
          <div className="text- flex items-center pb-2 pr-2 border-b-2 border-black uppercase">
            <svg
              className="h-6 mr-3"
              version="1.1"
              id="Capa_1"
            ...
            <div className="mt-3 text-center bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
              <div className="">
                <div
                  ...
                  className="text-xs text-black uppercase font-medium hover:text-gray-900 transition duration-500 ease-in-out"
                >
                  {data.catagory}
                </div>
                <div
                  ...
                  className="block text-gray-900 font-bold text-2xl mb-2 hover:text-black transition duration-500 ease-in-out"
                >
                  {data.title}
                </div>
