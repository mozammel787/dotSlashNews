            ...
            <Link to={`news/${data._id}`} key={data._id}>
              ...
              <div className="mt-3 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                <div className="">
                  <a
                    href="#"
                    className="text-xs text- uppercase font-medium mb-3 flex items-center hover:text-gray-900 transition duration-500 ease-in-out"
                  >
                    {data.catagory}
                  </a>
                  <a
                    href="#"
                    className="text-gray-900 font-bold text-lg mb-2 hover:text- transition duration-500 ease-in-out"
                  >
                    {data.title}
                  </a>
                </div>
