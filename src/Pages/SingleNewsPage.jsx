    ...
    <>
      <article className=" px-6 py-10 mx-auto space-y-12  text-gray-900">
        <div className=" container mx-auto ">
          <div className=" max-w-screen-lg mx-auto space-y-4 text-center">
            <p className="text-xs font-semibold tracking-wider uppercase  badge badge-neutral">
              {catagory}
            </p>
          ...
          <div className="text-gray-800 max-w-screen-xl mx-auto">
            <p className="text-center my-10">{description}</p>
          </div>
          <div className="py-12 border-t border-gray-300">
            <div className="max-w-lg mx-auto flex flex-col space-y-4 md:space-y-0 md:space-x-6 ">
              {authorPhoto ? (
                <img
                  src={authorPhoto}
                  alt=""
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex justify-start pt-4 space-x-4 align-center">
                  <a
                    ...
                    href="#"
                    aria-label="GitHub"
                    className="p-2 rounded-md text-gray-800 hover:text-black"
                  >
                    <svg
                      viewBox="0 0 496 512"
