          ...
          <div className="flex flex-col justify-between h-full p-3 w-60 bg-gray-50 text-gray-800">
            <div className="space-y-3">
              ...
              <div className="flex-1">
                <ul className="pt-10  pb-4 space-y-4 text-sm ">
                  <li className="hover:shadow border-0 bg-gray-100 hover:bg-gray-200  rounded btn w-full justify-start  ">
                    <Link
                      to={"/"}
                  ...
                  {/* <li className="hover:shadow bg-gray-100 hover:bg-gray-200  rounded btn w-full justify-start ">
